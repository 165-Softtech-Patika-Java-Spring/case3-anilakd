package com.anilakdemir.case3anilakd.prd.exception.exceptionHandler;
...
@ControllerAdvice
@RestController
public class PrdProductCustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler
    public final ResponseEntity<Object> handleUserNotFoundException(PrdProductNotFoundException exception, WebRequest webRequest){
